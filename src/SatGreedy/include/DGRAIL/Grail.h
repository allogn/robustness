...
struct GrailFail : public std::exception
{
	const char * what () const throw ()
	{
		return "Grail stupid library";
	}
};
...
//		delete[] pre;
	...
	public:
        dagger::DagWrapper dag;

		Grail();
		Grail(Graph&, int, int, int, ReachabilityLabels& );
		virtual ~Grail();
		void writeIndex();
		void integrityCheck();
